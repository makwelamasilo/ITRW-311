    ...
    public partial class Form2 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string MyConnection2 = "datasource=connection;port=3306;username=connection;password=@12345";
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string MyConnection2 = "datasource=localhost;port=3306;username=root;password=@Makwela98";
                string Query = "SELECT * from connectiontodatabase.student where ID='" + this.IdTextBox.Text + "';";
                MySqlConnection MyConn2 = new MySqlConnection(MyConnection2);
                MySqlCommand MyCommand2 = new MySqlCommand(Query, MyConn2);
                MySqlDataReader MyReader2;
                MyConn2.Open();
